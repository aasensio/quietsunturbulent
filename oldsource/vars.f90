...
implicit none
	...
	type atmosphereType		
		...
		real(kind=8), dimension(:), pointer :: lTau500, height, T, nodes, niovern, ui, u1, u2, u3, n2overn1, n1overn0, microturbulence
	...
	type transitionType
		integer :: nLambda
		logical :: active
		real(kind=8) :: lambda0, lambdaNew, lambdaKurucz, gf, Elow, geff, Gt, sigmaABO,	alphaABO, lambdaLeft, lambdaRight, lambdaContLeft, lambdaContRight
