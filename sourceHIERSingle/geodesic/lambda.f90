...
SUBROUTINE TrustRegion(n,m, fvec, fjac, dtd, delta, lam)
  ...
  REAL (KIND=8), allocatable :: jtilde(:,:) !! JFB, Mt. Stromlo, 8/8/2013
  ...
  REAL (KIND=8) gradCtilde(n), g(n,n)  !! JFB, Mt. Stromlo, 8/8/2013

  ALLOCATE (jtilde(m,n))  !! JFB, Mt. Stromlo, 8/8/2013
  ...
  DEALLOCATE(jtilde) !! JFB, Mt. Stromlo, 8/8/2013
